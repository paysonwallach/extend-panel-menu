...
const NightLightIndicator =
  Me.imports.indicators.nightlight.NightLightIndicator;
const NotificationIndicator =
  Me.imports.indicators.notification.NotificationIndicator;
...
function enable() {
  ...
  settingsChanged[i++] = settings.connect(
    "changed::autohide-notification",
    changeAutohide
  );
  settingsChanged[i++] = settings.connect(
    "changed::autohide-on-full-power",
    changeFullPowerHide
  );
  settingsChanged[i++] = settings.connect(
    "changed::autohide-on-percent",
    changePowerHide
  );
  settingsChanged[i++] = settings.connect(
    "changed::autohide-when-percent",
    changePowerHide
  );
  settingsChanged[i++] = settings.connect(
    "changed::autohide-power-icon-label",
    changePowerHide
  );
  settingsChanged[i++] = settings.connect(
    "changed::always-show-nightlight",
    changeNightLight
  );
