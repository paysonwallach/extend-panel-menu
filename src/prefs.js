...
var SettingsPage = new Lang.Class({
  ...
  _init: function(settings) {
    ...
    let dateFormatWikiButton = new Gtk.LinkButton({
      label: _("wiki"),
      uri:
        "https://help.gnome.org/users/gthumb/unstable/gthumb-date-formats.html"
      //xalign: 0,
      //hexpand: true,
      //image: new Gtk.Image({
    ...
    this.desktopSettings.bind(
      "show-battery-percentage",
      showPercentageLabelSwitch,
      "active",
      Gio.SettingsBindFlags.DEFAULT
    );
    showPercentageLabelRow.add(showPercentageLabelSwitch);

    autoHidePowerRow.add(
      new Gtk.Label({
    ...
    autoHidePowerSettingsButton.connect(
      "clicked",
      Lang.bind(this, function() {
    ...
    this.settings.bind(
      "always-show-nightlight",
      showNightLightSwitch,
      "active",
      Gio.SettingsBindFlags.DEFAULT
    );
...
var AdvancedPowerCustomizationWindow = new Lang.Class({
  ...
  _createLayout: function(vbox) {
    ...
    iconOrLabelCombo.set_active(
      this.settings.get_int("autohide-power-icon-label")
    );
    iconOrLabelCombo.connect(
      "changed",
  ...
  buildList: function() {
    ...
    for (let indexItem in items) {
      ...
      positionCombo.connect(
        "changed",
        Lang.bind(this, this.enableCenter, indexItem)
      );
...
var AboutPage = new Lang.Class({
  ...
  _init: function(settings) {
    ...
    let pixbuf = GdkPixbuf.Pixbuf.new_from_resource_at_scale(
      "resource:///org/gnome/shell/extensions/extend-panel-menu/icons/extend-panel-menu.png",
      imageWidth,
      imageHeight,
      false
    );
