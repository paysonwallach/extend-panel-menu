...
class VolumeIndicator extends CustomButton {
  _init() {
          ...
          if (player._mprisProxy.DesktopEntry) {
            ...
            if (players.indexOf(app) == -1) {
              this._settings.set_string(
                "players",
                this._settings.get_string("players") + "|" + app
              );
              this._addPlayer(app);
            }
          }
    ...
    settings.connect("activate", () =>
      this._openApp("gnome-sound-panel.desktop")
    );
